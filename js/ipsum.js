...
var people = ["Ash", "Ash Ketchum", "Ash's mom", "Brock", "Misty", "Officer Jenny", "Nurse Joy", "Gary", "Bill", "Pokemon Fan Club Chairman", "grumpy old man who needs coffee", "Professor Oak", "Professor Elm", "Giovanni", "Team Rocket", "Pikachu", "Meowth", "Jesse", "James", "Elite Four", "Satoshi Tajiri", "Junichi Masuda", "Pokemon Master"];
...
var types = ["Normal", "Fighting", "Flying", "Poison", "Ground", "Rock", "Bug", "Ghost", "Water", "Grass", "Electric", "Psychic", "Ice", "Dragon", "Dark", "Steel", "Fire"];
var versions = ["Red", "Blue", "Gold", "Silver", "Yellow", "Fire Red", "Leaf Green", "Ruby", "Sapphire"]

// Combines the sentence arrays
var combinedTerms = latin.concat(badges, items, lyrics, moves, people, pokemon, regions, towns, types);
